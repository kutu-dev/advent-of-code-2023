...
int main()
{
    ...
    char *final_calibration_value_converted = malloc(length_valid_calibration_value);
    snprintf(final_calibration_value_converted, length_valid_calibration_value, answer_format, final_calibration_value);

    info_print("1", "1", final_calibration_value_converted);
    free(final_calibration_value_converted);
